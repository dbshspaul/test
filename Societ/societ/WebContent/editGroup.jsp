...
<div class="art-layout-cell art-content">
	<div class="art-block clearfix" style="margin-top: 0px">
		...
		<div class="art-layout-cell art-sidebar2">
			<div class="art-blockcontent">
				<h1>&nbsp Group</h1>
				<center>Update group details..</center>
			</div>
		</div>
	...
	<div style="margin-left: 25px; margin-top: 25px; margin-right: 25px">
		<c:set var="group"
			value="${sessionScope['userBean'].getGroupById(param.groupId)}" />
		<form action="editGroup" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<td>Name:</td>
					<td><input type="text" name="grpnm" value="${group.groupName}"></td>
					<td rowspan="2"><img alt=""
						src="data:image/jpeg;base64,${group.imageAsString}" height="100"></td>
				</tr>
				<tr>
					<td>Description of the group:</td>
					<td><textarea rows="6" cols="13" name="grpdesc">${group.groupDesc}</textarea></td>
					<td><a href="changeGroupPic.jsp?groupId=${group.groupId}" target="_blank">change
							picture?</a></td>
				</tr>
				<tr>
					<td>Type of the group:</td>
					<td><input type="text" name="grptype"
						value="${group.groupType}"></td>
				</tr>
				<tr>

					<td colspan="2"><input type="hidden" value="${group.groupId}"
						name="groupId"><input type="submit" value="Update Group"></td>
				</tr>
			</table>
		</form>
	</div>
