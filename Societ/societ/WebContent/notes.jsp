...
<div class="art-layout-cell art-content">
	<div class="art-block clearfix" style="margin-top: 0px">
		...
		<div class="art-layout-cell art-sidebar2">
			<div class="art-blockcontent">
				<h1>Note</h1>
				<center>Create, edit, delete, view memorable note.</center>
			</div>
		</div>
	</div>

	<div style="margin-left: 25px; margin-top: 25px; margin-right: 25px">
		<c:set var="notLst" value="${sessionScope['noteBean']['allNotes']}"></c:set>
		<table align="center">
			<tr>
				<td><div align="center">
						<a href="createNote.jsp"><input type="button"
							value="Create new note"> </a>

					</div></td>
			</tr>
		</table>
		<div id="accordion">
			<c:forEach items="${notLst}" var="note">
				<h3>${note.noteTitle}
					<div style="font-size: 10pt;">
						<fmt:formatDate value="${note.creationDate}"
				...
				<div>
					<p>${note.note}</p>
					<a href="editNote?noteId=${note.noteId}">Edit note</a> <a
						href="deleteNote?noteId=${note.noteId}">Delete note</a>
				</div>
			</c:forEach>
		</div>
	</div>
