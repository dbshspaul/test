...
<div class="art-layout-cell art-content">
	<div class="art-block clearfix" style="margin-top: 0px">
		...
		<div class="art-layout-cell art-sidebar2">
			<div class="art-blockcontent">
				<h1>&nbsp Group</h1>
				<center>Change group picture.</center>
			</div>
		</div>
	...
	<div style="margin-left: 25px; margin-top: 25px; margin-right: 25px">
		...
		<form action="changeGroupPic" enctype="multipart/form-data"
			method="post">
			<input type="file" name="img"> <input type="hidden" name="id"
				value="${param.groupId}"> <input type="submit"
				value="change">
		</form>
	</div>
</div>
