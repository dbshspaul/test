...
<div class="art-layout-cell art-content">
	...
	<div style="margin-left: 25px; margin-top: 25px; margin-right: 25px">
		<c:set var="messages"
			value="${sessionScope['messageBean'].getOutboxMessages()}" />
		<table>
			<tr>
				<td><table>
						<tr>
						...
						<tr>
							<td><a href="#">Outbox</a></td>
						</tr>
					</table></td>
				<td><span style="color: silver; font-size: 4ex;">OUTBOX</span>
						...
						<table>
							<tr>
								...
								<td><fmt:formatDate value="${message.messageSendDate}"
									...
									href="deleteOutboxMessage?msgid=${message.messageId}">delete</a></td>
							</tr>
						</table>
					</c:forEach></td>
			</tr>
