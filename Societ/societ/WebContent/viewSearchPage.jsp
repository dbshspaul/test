...
<div class="art-layout-cell art-content">
	<div class="art-block clearfix" style="margin-top: 0px">
		...
		<div class="art-layout-cell art-sidebar2">
			<div class="art-blockcontent">
				...
				<center>Page search result.</center>
			</div>
		</div>
	...
	<div style="margin-left: 25px; margin-top: 25px; margin-right: 25px">
		...
		<div align="left">
			<c:set var="pages"
				value="${sessionScope['userBean'].getAllPagesByName(param.pageName)}" />
			<c:forEach items="${pages}" var="page">
				<table>
					<tr>
						<td><h3>${page.pageName}</h3></td>
					</tr>
					<tr>
						<td><a href="viewfPage?pageId=${page.pageId}"><img alt=""
