...
<div class="art-layout-cell art-content">
	...
	<div style="margin-left: 25px; margin-top: 25px; margin-right: 25px">
		<c:set var="usrlst" value="${sessionScope['userBean'].getAllUser()}" />
		<table>
			<tr>
				<td><table>
						<tr>
							<td><a href="#">Write Message</a></td>
						</tr>
						<tr>
				...
				<td><form action="sendMessage" method="post">
						<table border="0" width="35%" align="center">
							<caption>Send New Message.</caption>
							<tr>
								<td width="50%">Recipient address</td>
								<td><input id="recipient" type="text" name="id" size="50" /></td>
							</tr>
