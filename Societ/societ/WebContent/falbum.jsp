...
<div class="art-layout-cell art-content">
	...
	<div style="margin-left: 25px; margin-top: 25px; margin-right: 25px">
		<c:set var="albums"
			value="${sessionScope['picBean'].getAllAlbumsByUserId(requestScope['fid'])}" />
		<c:forEach items="${albums}" var="album">
			<table>
				<tr>
					<td><a href="viewfAlbum?albumId=${album.albumId}"
						target="_blank">
							<table width="128px" height="128px" background="images/album.png"
								cellpadding="5" cellspacing="0">
								<tr>
									<td valign="bottom">
										<p>
											<font color="#ffffff"> <a
												href="viewfAlbum?albumId=${album.albumId}" target="_blank">
					...
					<td><font color="gray">&nbsp &nbsp &nbsp Created on <fmt:formatDate
								value="${album.creationDate}" pattern="hh:mm:ssa DD/MM/YY" /></font>
					</td>
				</tr>
			</table>
			<hr>
