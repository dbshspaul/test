			...
			<div class="art-layout-cell art-content">
				<div class="art-block clearfix" style="margin-top: 0px">
					...
					<div class="art-layout-cell art-sidebar2">
						<div class="art-blockcontent">
							<h1>Create Note</h1>
							<center>Create a memorable or to do note.</center>
						</div>
					</div>
				</div>
				...
				<div style="margin-left: 50px; margin-top: 50px">
					...
					<div id="contact_form">
						<form method="post" name="" action="createNote">
							<label for="noteTitle">Note title:</label> <input type="text" id="" name="noteTitle"
								class="required input_field"
								required="" />
							<div class="cleaner_h10"></div>

							<label for="note">Note:</label>
							<textarea id="text" name="note" rows="0" cols="0"
								 class="required"></textarea>
							<div class="cleaner_h10"></div>

							<input type="submit" class="submit_btn" name="submit" id="submit"
								value="Save Note" /> <input type="reset" class="submit_btn"
